...
<div class="quick-actions" style="margin-bottom: 2rem;">
    ...
    <div class="action-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(200px, 1fr)); gap: 1rem; margin-top: 1rem;">
        <a href="/GLC_AIMS/student/grades.php" class="action-card">
        ...
        <a href="/GLC_AIMS/student/borrow.php" class="action-card">
            <div class="action-icon">
                <i class="fas fa-hand-holding"></i>
            </div>
            <div class="action-content">
        ...
        <a href="/GLC_AIMS/student/files.php" class="action-card">
            <div class="action-icon">
                <i class="fas fa-folder"></i>
            </div>
            <div class="action-content">
        ...
        <a href="/GLC_AIMS/student/announcements.php" class="action-card">
            <div class="action-icon">
...
<div class="grid grid-2" style="gap: 2rem;">
    ...
    <div class="dashboard-section">
        <div class="section-header">
            ...
            <a href="/GLC_AIMS/student/grades.php" class="btn-link">View All</a>
        </div>
    ...
    <div class="dashboard-section">
        <div class="section-header">
            ...
            <a href="/GLC_AIMS/student/borrow.php" class="btn-link">View All</a>
        </div>
        ...
        <?php if (empty($activeBorrows)): ?>
            <div class="empty-state">
                ...
                <a href="/GLC_AIMS/student/borrow.php" class="btn btn-primary" style="margin-top: 1rem;">
...
<div class="grid grid-2" style="gap: 2rem; margin-top: 2rem;">
    ...
    <div class="dashboard-section">
        <div class="section-header">
            ...
            <a href="/GLC_AIMS/student/files.php" class="btn-link">View All</a>
        </div>
    ...
    <div class="dashboard-section">
        <div class="section-header">
            ...
            <a href="/GLC_AIMS/student/announcements.php" class="btn-link">View All</a>
        </div>
