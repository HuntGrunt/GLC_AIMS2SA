...
<body>
    <div class="error-container">
        ...
        <div class="action-buttons">
            ...
            <?php if (isset($_SESSION['user_id'])): ?>
                <a href="/GLC_AIMS/<?= strtolower(str_replace(' ', '_', $_SESSION['role_name'])) ?>/dashboard.php" class="btn btn-primary">
                    <i class="fas fa-home"></i>
                    My Dashboard
                </a>
            <?php else: ?>
                <a href="/GLC_AIMS/login.php" class="btn btn-primary">
                    <i class="fas fa-sign-in-alt"></i>
                    Login
                </a>
            <?php endif; ?>
            
            <a href="/GLC_AIMS/logout.php" class="btn btn-secondary">
    ...
    <script>
        ...
        setTimeout(function() {
            <?php if (isset($_SESSION['user_id'])): ?>
                window.location.href = '/GLC_AIMS/<?= strtolower(str_replace(' ', '_', $_SESSION['role_name'])) ?>/dashboard.php';
            <?php else: ?>
                window.location.href = '/GLC_AIMS/login.php';
            <?php endif; ?>
        }, 10000);
    </script>
</body>
