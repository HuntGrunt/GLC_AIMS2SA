...
<?php if (($borrowStats['overdue_items'] ?? 0) > 0): ?>
    <div class="alert alert-warning" style="margin-bottom: 2rem;">
        ...
        <div>
            ...
            <a href="/GLC_AIMS/sao/borrow_requests.php?status=overdue" style="color: inherit; text-decoration: underline;">View overdue items</a></p>
        </div>
    </div>
<?php endif; ?>
...
<div class="quick-actions" style="margin-bottom: 2rem;">
    ...
    <div class="action-grid" style="display: grid; grid-template-columns: repeat(auto-fit, minmax(250px, 1fr)); gap: 1rem; margin-top: 1rem;">
        <a href="/GLC_AIMS/sao/borrow_requests.php?status=pending" class="action-card">
        ...
        <a href="/GLC_AIMS/sao/inventory.php" class="action-card">
        ...
        <a href="/GLC_AIMS/sao/announcements.php" class="action-card">
        ...
        <a href="/GLC_AIMS/sao/reports.php" class="action-card">
...
<div class="grid grid-2" style="gap: 2rem; margin-bottom: 2rem;">
    ...
    <div class="dashboard-section">
        <div class="section-header">
            ...
            <a href="/GLC_AIMS/sao/borrow_requests.php?status=pending" class="btn-link">View All</a>
        </div>
                ...
                <?php foreach ($recentBorrowRequests as $request): ?>
                    <div class="request-item">
                        ...
                        <div class="request-actions">
                            <a href="/GLC_AIMS/sao/borrow_requests.php#request-<?= $request['id'] ?>" class="btn-sm btn-primary">
    ...
    <div class="dashboard-section">
        <div class="section-header">
            ...
            <a href="/GLC_AIMS/sao/borrow_requests.php?status=overdue" class="btn-link">View All</a>
        </div>
...
<div class="grid grid-2" style="gap: 2rem;">
    ...
    <div class="dashboard-section">
        <div class="section-header">
            ...
            <a href="/GLC_AIMS/sao/inventory.php?filter=low_stock" class="btn-link">View All</a>
        </div>
    ...
    <div class="dashboard-section">
        <div class="section-header">
            ...
            <a href="/GLC_AIMS/sao/borrow_requests.php?status=returned" class="btn-link">View All</a>
        </div>
